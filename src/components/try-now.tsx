...
const TryNow = () => {
  ...
  return (
    ...
    <section id='try_now' className='padding-inline section'>
      ...
      <div className='container relative flex flex-col items-start justify-between gap-8 overflow-clip rounded-2.5xl bg-black-gradient ~px-6/24 ~py-12/[4.5rem] sm:flex-row sm:items-center'>
